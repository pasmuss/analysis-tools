...
void PlotMCsigMasses120_350_600_1200(){
  ...
  /// Files
  ///
  TFile* file_350w = new TFile("/afs/desy.de/user/a/asmusspa/Documents/CMSSW_9_2_15/src/Analysis/Tools/test/Configs_diffBTags_allmedium/rootfiles_4med_comp-incl-asym-pT-incl-onl-MC-sf_Sep25-19/mcsig/mc-sig-350-NLO-deep-SR-3j.root","READ");
  TFile* file_600w = new TFile("/afs/desy.de/user/a/asmusspa/Documents/CMSSW_9_2_15/src/Analysis/Tools/test/Configs_diffBTags_allmedium/rootfiles_4med_comp-incl-asym-pT-incl-onl-MC-sf_Sep25-19/mcsig/mc-sig-600-NLO-deep-SR-3j.root","READ");
  TFile* file_1200w = new TFile("/afs/desy.de/user/a/asmusspa/Documents/CMSSW_9_2_15/src/Analysis/Tools/test/Configs_diffBTags_allmedium/rootfiles_4med_comp-incl-asym-pT-incl-onl-MC-sf_Sep25-19/mcsig/mc-sig-1200-NLO-deep-SR-3j.root","READ");
  ...
  hist_m_350w -> GetYaxis() -> SetRangeUser(0.1,11000);
  ...
  TLegend* leg = new TLegend(0.28,0.63,0.84,0.89);
  style.SetLegendStyle(leg);
  //leg -> SetBorderSize(1);
  leg -> AddEntry(hist_m_350w,"m_{A/H} = 350 GeV, onl. btag sf + asym. p_{T}","L");
  leg -> AddEntry(hist_m_350wo,"m_{A/H} = 350 GeV, without both","L");
  leg -> AddEntry(hist_m_600w,"m_{A/H} = 600 GeV, onl. btag sf + asym. p_{T}","L");
  leg -> AddEntry(hist_m_600wo,"m_{A/H} = 600 GeV, without both","L");
  leg -> AddEntry(hist_m_1200w,"m_{A/H} = 1200 GeV, onl. btag sf + asym. p_{T}","L");
  ...
  can -> Update();
  can -> SaveAs("Outputdata/sig_masses_comp_w-wo-onl-btag-sf-and-asym-pt-3j.pdf");
}
