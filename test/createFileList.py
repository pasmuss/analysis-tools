...
basedir = '/pnfs/desy.de/cms/tier2/store/user/rwalsh/Analysis/Ntuples/DATA/Run2017/ntuplizer_94X_2017_rereco31Mar18-v4/ZeroBias/'
prefix = 'Run2017'
suffix = '-31Mar2018-v1/'
eras = ['C','D','E','F']
...
for era in eras:
    ntuplelist = []
    print(era)
    with open('filelists/rootFileList_ZeroBias_2017'+str(era)+'.txt','w') as filelist:
