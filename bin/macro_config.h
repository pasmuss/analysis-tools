...
int macro_config(int argc, char * argv[])
{
  try
	...
	("nMuonsMin",po::value <int> (&nmuonsmin_)->default_value(1),"Minimum number of muons")
	...
	("muonsId",po::value <std::string> (&muonsid_)->default_value("T"),"muons id criteria for all muons")
	//
	...
	//
	("dRMin",po::value <float> (&drmin_)->default_value(1.0),"Minimum delta R between candidates")
	("dRMax",po::value <float> (&drmax_)->default_value(0.4),"Maximum delta R between candidates")
	("dEtaMax",po::value <float> (&detamax_)->default_value(1.5),"Maximum delta eta between candidates")
	...
	("m12Min",po::value <float> (&m12min_)->default_value(200.0),"Minimum value of m12 (mass of leading two jets)")
	...
	//      
	("btagAlgorithm",po::value <std::string> (&btagalgo_)->default_value("deepflavour"),"BTag algorithm")
